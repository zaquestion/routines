...
func main() {
	...
	*/
	...
	{
		//scraptrelloresetDuration := duration.With(metrics.Field{Key: "method", Value: "ScrapTrelloReset})"
		//scraptrelloresetLogger := log.NewContext(logger).With("method", "ScrapTrelloReset)")

		scraptrelloresetEndpoint = svc.MakeScrapTrelloResetEndpoint(service)
		//scraptrelloresetEndpoint = opentracing.TraceServer(tracer, "ScrapTrelloReset)")(scraptrelloresetEndpoint)
		//scraptrelloresetEndpoint = svc.EndpointInstrumentingMiddleware(scraptrelloresetDuration)(scraptrelloresetEndpoint)
		//scraptrelloresetEndpoint = svc.EndpointLoggingMiddleware(scraptrelloresetLogger)(scraptrelloresetEndpoint)
	}

	var getroutinesEndpoint endpoint.Endpoint
	{
		//getroutinesDuration := duration.With(metrics.Field{Key: "method", Value: "GetRoutines})"
		//getroutinesLogger := log.NewContext(logger).With("method", "GetRoutines)")

		getroutinesEndpoint = svc.MakeGetRoutinesEndpoint(service)
		//getroutinesEndpoint = opentracing.TraceServer(tracer, "GetRoutines)")(getroutinesEndpoint)
		//getroutinesEndpoint = svc.EndpointInstrumentingMiddleware(getroutinesDuration)(getroutinesEndpoint)
		//getroutinesEndpoint = svc.EndpointLoggingMiddleware(getroutinesLogger)(getroutinesEndpoint)
	}
	...
	go func() {
		...
		s := grpc.NewServer()
		pb.RegisterRoutinesServiceServer(s, srv)
