...
import (
	...
	"github.com/zaquestion/routines/routines-service/handlers"
	"github.com/zaquestion/routines/routines-service/middlewares"
...
func Run(cfg Config, logger log.Logger) {
	...
	go func() {
		...
		s := grpc.NewServer()
		pb.RegisterRoutinesServer(s, srv)
